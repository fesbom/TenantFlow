...
// Migração idempotente de compatibilidade para ambientes existentes.
// O arquivo migrations/0001_superadmin_backoffice.sql continua sendo a fonte
// versionada; este guard evita que deployments antigos iniciem com schema parcial.
